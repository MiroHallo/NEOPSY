...
*   **4.0 (Fjord) — Numerical Engine Revision** | March 2026
    *   Public release
    *   Integration with Geopsy 3.X
    *   New Outputs: Output ASCII files with resultant layer interfaces, MAP model uncertainty, amplification, and V<sub>S30</sub>
...
*   **2.0 (Desert) — Numerical Engine Revision** | May 2020
    ...
    *   Enhanced Engine: Improved search for layers with inverse velocity, improved birth from prior, new MAP model search
...
Note: See connected example files for `data.para`, `input.para`, and observed dispersion and ellipticity curves in `./data`
